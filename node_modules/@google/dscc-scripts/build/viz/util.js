...
exports.validateBuildValues = (args) => {
    ...
    const devBucket = "gs://almabetter/alma-dev"; //process.env.npm_package_dsccViz_gcsDevBucket;
    if (devBucket === undefined) {
        throw util_1.invalidVizConfig('gcsDevBucket');
    }
    const prodBucket = "gs://almabetter/alma-prod"; //process.env.npm_package_dsccViz_gcsProdBucket;
